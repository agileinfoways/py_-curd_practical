...
- Take Project build pull from Docker Hub using Command : `docker pull shubhamagile/curd_demo:x86_arch`
- Run Docker Image using Command : `docker run -p 8000:8000 shubhamagile/curd_demo:x86_arch`
- If you Don't get any errors, you have successfully run project, goto browser and type `localhost:8000` you should see the project.

## Setting Up and Running Project Using Docker For ARM Architecture System (Apple M1 Processor based systems)
- Install Docker on your system 
- Take Project build pull from Docker Hub using Command : `docker pull shubhamagile/curd_demo:arm_arch`
- Run Docker Image using Command : `docker run -p 8000:8000 shubhamagile/curd_demo:arm_arch`
- If you Don't get any errors, you have successfully run project, goto browser and type `localhost:8000` you should see the project.
